...
import { UserProvider } from '../components/UserContext/UserContext'; // Importez le UserProvider
  ...
  return (
      <Router>
        ...
        <Routes>
          ...
          <Route path="/user" element={<User setIsUserLoggedIn={setIsUserLoggedIn} />} /> {/* Ici */}
