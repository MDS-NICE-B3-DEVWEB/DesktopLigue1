...
const LoginForm = () => {
  ...
  Email:
  <input type="email" value={email} onChange={e => setEmail(e.target.value)} required style={{height: '40px', borderColor: 'white', borderWidth: '1px', borderRadius: '10px', marginBottom: '16px', paddingLeft: '8px', color: '#CEFB03'}} />
</label>
<label style={{color: '#CEFB03'}}>
  Password:
  <input type="password" value={password} onChange={e => setPassword(e.target.value)} required style={{height: '40px', borderColor: 'white', borderWidth: '1px', borderRadius: '10px', marginBottom: '16px', paddingLeft: '8px', color: '#CEFB03'}} />
</label>
