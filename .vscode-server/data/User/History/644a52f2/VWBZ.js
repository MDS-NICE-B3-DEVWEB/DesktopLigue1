...
const styles = {
  container: {
      ...
      position: 'relative', // Changed from 'sticky' to 'absolute'
...
const TopEquipe = () => {
  return (
    <div  style={styles.container} >
      {/* ASM */}
      <Link to="/ShowEquipe/76" style={{ backgroundColor: '#db0632' }}>
        <img src={asmLogo} style={styles.image} alt="ASM" />
      </Link>

      {/* CM63 */}
      <Link to="/ShowEquipe/622" style={{ backgroundColor: '#002d6a' }}>
        <img src={cm63Logo} style={styles.image} alt="CM63" />
      </Link>
