    ...
    public function classementApi(Request $request)
    {
        ...
        $teams = array_map(function($team) {
            return [
                ...
                'matchesWon' => isset($team['win_chk']) ,
                'matchesDrawn' => isset($team['draw_chk']) ,
                'matchesLost' => isset($team['lost_chk']) ,
                ...
                ? intval($team['home_win_pts']) + intval($team['away_win_pts']) + intval($team['home_draw_pts']) + intval($team['away_draw_pts']) - intval($team['home_loose_pts']) - intval($team['away_loose_pts'])
                : 0,
            ];
