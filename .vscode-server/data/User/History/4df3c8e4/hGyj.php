    ...
    public function classementApi(Request $request)
    {
        ...
        $teams = array_map(function($team) {
            return [
                ...
                'matchesDrawn' => $team['draw_chk'],
                'matchesLost' => $team['lost_chk'],
                'points' => $team['home_win_pts'] + $team['away_win_pts'] + $team['home_draw_pts'] + $team['away_draw_pts'] - $team['home_loose_pts'] - $team['away_loose_pts'],
            ];
