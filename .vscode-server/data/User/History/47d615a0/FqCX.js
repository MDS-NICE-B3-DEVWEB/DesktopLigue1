...
function AccueilSceen() {
  const settings = {
    ...
    slidesToScroll: 1,
    autoplay: true,
    nextArrow: null, // Pour enlever la flèche de navigation droite
    prevArrow: false, // Pour enlever la flèche de navigation gauche
    autoplaySpeed: 6000,
    responsive: [
      {
        breakpoint: 1024,
  ...
  return (
    ...
    <Slider {...settings}>
      <div>
        ...
        {/* Ajoutez d'autres images pour le carrousel ici */}
      </Slider>
      </div>
      ...
      <div className='summary'>
        ...
        <div>
          <img src={imghome1} alt="ligue1" />
        </div>
      </div>
      <div className='summary'>
        <div>
          <img src={imghome2} alt="ballon" />
        </div>
        <div>
