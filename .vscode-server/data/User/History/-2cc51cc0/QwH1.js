...
const Equipe = () => {
  ...
  return (
    <div className="container">
      ...
      <button onClick={() => handleTeamPress(77)} className="teamContainer" style={{backgroundColor: '#f7f7f7'}}>
        <img src={cm63Logo} className="teamLogo" alt="CM63" />
        <p className="teamName">CM63</p>
        </button>
        <button onClick={() => handleTeamPress(78)} className="teamContainer" style={{backgroundColor: '#f7f7f7'}}>
            <img src={fclLogo} className="teamLogo" alt="FCL" />
            <p className="teamName">FCL</p>
        </button>
        <button onClick={() => handleTeamPress(79)} className="teamContainer" style={{backgroundColor: '#f7f7f7'}}>
            <img src={fcmLogo} className="teamLogo" alt="FCM" />
            <p className="teamName">FCM</p>
        </button>
        <button onClick={() => handleTeamPress(80)} className="teamContainer" style={{backgroundColor: '#f7f7f7'}}>
            <img src={fcnLogo} className="teamLogo" alt="FCN" />
            <p className="teamName">FCN</p>
        </button>
        <button onClick={() => handleTeamPress(81)} className="teamContainer" style={{backgroundColor: '#f7f7f7'}}>
            <img src={hacLogo} className="teamLogo" alt="HAC" />
            <p className="teamName">HAC</p>
        </button>
        <button onClick={() => handleTeamPress(82)} className="teamContainer" style={{backgroundColor: '#f7f7f7'}}>
            <img src={loscLogo}
                    className="teamLogo" alt="LOSC" />
            <p className="teamName">LOSC</p>
        </button>
        <button onClick={() => handleTeamPress(83)} className="teamContainer" style={{backgroundColor: '#f7f7f7'}}>
            <img src={mhscLogo} className="teamLogo" alt="MHSC" />
            <p className="teamName">MHSC</p>
        </button>
        <button onClick={() => handleTeamPress(84)} className="teamContainer" style={{backgroundColor: '#f7f7f7'}}>
            <img src={ogcnLogo} className="teamLogo" alt="OGCN" />
            <p className="teamName">OGCN</p>
        </button>
        <button onClick={() => handleTeamPress(85)} className="teamContainer" style={{backgroundColor: '#f7f7f7'}}>
            <img src={olLogo} className="teamLogo" alt="OL" />
            <p className="teamName">OL</p>
        </button>
        <button onClick={() => handleTeamPress(86)} className="teamContainer" style={{backgroundColor: '#f7f7f7'}}>
            <img src={omLogo} className="teamLogo" alt="OM" />
            <p className="teamName">OM</p>
        </button>
        <button onClick={() => handleTeamPress(87)} className="teamContainer" style={{backgroundColor: '#f7f7f7'}}>
            <img src={psgLogo} className="teamLogo" alt="PSG" />
            <p className="teamName">PSG</p>
        </button>
        <button onClick={() => handleTeamPress(88)} className="teamContainer" style={{backgroundColor: '#f7f7f7'}}>
            <img src={rclLogo} className="teamLogo" alt="RCL" />
            <p className="teamName">RCL</p>
        </button>
        <button onClick={() => handleTeamPress(89)} className="teamContainer" style={{backgroundColor: '#f7f7f7'}}>
            <img src={rcsaLogo} className="teamLogo" alt="RCSA" />
            <p className="teamName">RCSA</p>
        </button>
        <button onClick={() => handleTeamPress(90)} className="teamContainer" style={{backgroundColor: '#f7f7f7'}}>
            <img src={sb29Logo} className="teamLogo" alt="SB29" />
            <p className="teamName">SB29</p>
        </button>
        <button onClick={() => handleTeamPress(91)} className="teamContainer" style={{backgroundColor: '#f7f7f7'}}>
            <img src={sdrLogo} className="teamLogo" alt="SDR" />
            <p className="teamName">SDR</p>
        </button>
        <button onClick={() => handleTeamPress(92)} className="teamContainer" style={{backgroundColor: '#f7f7f7'}}>
            <img src={srfcLogo} className="teamLogo" alt="SRFC" />
            <p className="teamName">SRFC</p>
        </button>
        <button onClick={() => handleTeamPress(93)} className="teamContainer" style={{backgroundColor: '#f7f7f7'}}>
