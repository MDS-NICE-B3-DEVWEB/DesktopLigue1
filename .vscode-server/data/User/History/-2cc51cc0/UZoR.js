...
const Equipe = () => {
  ...
  return (
    <div className="container">
      <Link to="/show-team/76" className="teamContainer" style={{backgroundColor: '#db0632'}}>
        <img src={asmLogo} className="teamLogo" alt="ASM" />
        <p className="teamName">ASM</p>
      </Link>
      <Link to="/show-team/77" className="teamContainer" style={{backgroundColor: '#002d6a'}}>
        <img src={cm63Logo} className="teamLogo" alt="CM63" />
        <p className="teamName">CM63</p>
      </Link>
      <Link to="/show-team/78" className="teamContainer" style={{backgroundColor: '#FF4A00'}}>
        <img src={fclLogo} className="teamLogo" alt="FCL" />
        <p className="teamName">FCL</p>
      </Link>
      <Link to="/show-team/79" className="teamContainer" style={{backgroundColor: '#ffffff'}}>
        <img src={fcmLogo} className="teamLogo" alt="FCM" />
        <p className="teamName" style={{color: '#02153C'}}>FCM</p>
      </Link>
      <Link to="/show-team/80" className="teamContainer" style={{backgroundColor: '#00a558'}}>
        <img src={fcnLogo} className="teamLogo" alt="FCN" />
        <p className="teamName">FCN</p>
      </Link>
      <Link to="/show-team/81" className="teamContainer" style={{backgroundColor: '#8cc2e6'}}>
        <img src={hacLogo} className="teamLogo" alt="HAC" />
        <p className="teamName">HAC</p>
      </Link>
      <Link to="/show-team/82" className="teamContainer" style={{backgroundColor: '#e41b13'}}>
        <img src={loscLogo} className="teamLogo" alt="LOSC" />
        <p className="teamName">LOSC</p>
      </Link>
      <Link to="/show-team/83" className="teamContainer" style={{backgroundColor: '#07195E'}}>
        <img src={mhscLogo} className="teamLogo" alt="MHSC" />
        <p className="teamName">MHSC</p>
      </Link>
      <Link to="/show-team/84" className="teamContainer" style={{backgroundColor: '#D52027'}}>
        <img src={ogcnLogo} className="teamLogo" alt="OGCN" />
        <p className="teamName">OGCN</p>
      </Link>
      <Link to="/show-team/85" className="teamContainer" style={{backgroundColor: '#ffffff'}}>
        <img src={olLogo} className="teamLogo" alt="OL" />
        <p className="teamName" style={{color: '#02153C'}}>OL</p>
      </Link>
      <Link to="/show-team/86" className="teamContainer" style={{backgroundColor: '#0F23AA'}}>
        <img src={omLogo} className="teamLogo" alt="OM" />
        <p className="teamName">OM</p>
      </Link>
      <Link to="/show-team/87" className="teamContainer" style={{backgroundColor: '#ffffff'}}>
        <img src={psgLogo} className="teamLogo" alt="PSG" />
        <p className="teamName" style={{color: '#02153C'}}>PSG</p>
      </Link>
      <Link to="/show-team/88" className="teamContainer" style={{backgroundColor: '#f6d410'}}>
        <img src={rclLogo} className="teamLogo" alt="RCL" />
        <p className="teamName">RCL</p>
      </Link>
      <Link to="/show-team/89" className="teamContainer" style={{backgroundColor: '#009ee2'}}>
        <img src={rcsaLogo} className="teamLogo" alt="RCSA" />
        <p className="teamName">RCSA</p>
      </Link>
      <Link to="/show-team/90" className="teamContainer" style={{backgroundColor: '#e41a25'}}>
        <img src={sb29Logo} className="teamLogo" alt="SB29" />
        <p className="teamName">SB29</p>
      </Link>
      <Link to="/show-team/91" className="teamContainer" style={{backgroundColor: '#ffffff'}}>
        <img src={sdrLogo}  className="teamLogo" alt="SDR" />
        <p className="teamName"  style={{color: '#02153C'}}>SDR</p>
      </Link>
      <Link to="/show-team/92" className="teamContainer" style={{backgroundColor: '#d82626'}}>
        <img src={srfcLogo} className="teamLogo" alt="SRFC" />
        <p className="teamName">SRFC</p>
      </Link>
      <Link to="/show-team/93" className="teamContainer" style={{backgroundColor: '#3e2b57'}}>
