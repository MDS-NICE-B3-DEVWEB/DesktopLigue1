  ...
  useEffect(() => {
    const fetchPlayers = async () => {
      try {
        ...
        if (penaltyScorersResponse && penaltyScorersResponse.items && penaltyScorersResponse.items.season && penaltyScorersResponse.items.season.players) {
          setGoalScorers(penaltyScorersResponse.items.season.players);
        } else {
          console.error('Error: data not found in response');
        }
